...
quadr_comm = patches.Rectangle((0, 0), -28, 28, color='#FF0000')
ax.add_patch(quadr_comm)

#Красим квадрант фашистов
quadr_fash = patches.Rectangle((0, 0), 28, 28, color='#009966')
ax.add_patch(quadr_fash)

#Красим квадрант либеральных леваков
quadr_llib = patches.Rectangle((0, 0), -28, -28, color='#0099CC')
ax.add_patch(quadr_llib)

#Красим квадрант правых либералов
quadr_rlib = patches.Rectangle((0, 0), 28, -28, color='#FFCC00')
